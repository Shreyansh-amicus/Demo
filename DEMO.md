...
## I am making this text to test a few things out.

- Just to check what happens if things go right.

# Wanting to test the git blame -C -L command.
...
=======
- I am updating this file to test some more remote stuff.
>>>>>>> parent of 6a91a02 (Modify DEMO.md)
